...
public class JsonMapper {
    ...
    public static <T> String obj2String(T src){
        ...
        try{
            ...
            log.warn("pares object to String exception,error:{}",e);
            return null;
        }
    }
   ...
   public static  <T> T string2Obj(String src, TypeReference<T> tTypeReference){
        ...
        try{
            ...
            log.error("parse String to Object exception,String:{},tTypeReference<T>:{},error:{}",src,tTypeReference.getType(),e);
            return null;
        }
   }
}
